            ...
            <div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                <div class="max-w-md mx-auto">
                        <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                            <p><h1><b>Great!</p> <p>Find the lot you're interested in by filling the following form</p></b></h1>
                                <form method="post" action="${pageContext.request.contextPath}/lots/searchLot">
                                    <ul class="list-disc space-y-2">
                                        <li> Type in the lot's name or information about it
                                            <div class="mb-3 pt-0">
                                                <input type="text" name = "input" class="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-full"/>
                                            </div>
                                        </li>
                                        <button class = "bg-blue-300 text-x1 font-semibold px-4 py-1 rounded hover:bg-blue-800 hover:text-white " type="submit">Search</button>
                                    </ul>
                                </form>
                        </div>
                </div>
            ...
            <div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                <div class="max-w-md mx-auto">
                    <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                        ...
                        <p><h1><b>Sorry</p> <p>No lots were found. Try again</p></b></h1>
                        <form method="post" action="${pageContext.request.contextPath}/lots/searchLot">
                            <ul class="list-disc space-y-2">
                                <li> Type in the lot's name or information about it
                                    <div class="mb-3 pt-0">
                        ...
                        <c:if test="${lotsFound.size()!=0}" >
                            <p><h1><b>Great!</p> <p>Here are the lots we've found</p></b></h1>
                            <c:if test="${user==null}" >
                            ...
                            <form method="get" action="${pageContext.request.contextPath}/lots/searchLot">
                                <button class = "bg-blue-300 text-x1 font-semibold px-4 py-1 rounded hover:bg-blue-800 hover:text-white " type="submit">Search again</button>
                            </form>
                            <form method="get" action="${pageContext.request.contextPath}/lots/default">
